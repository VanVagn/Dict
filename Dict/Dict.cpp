...
// Dict.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDictApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDictApp::OnAppAbout)
...
CDictApp::CDictApp() noexcept
{
	...
	SetAppID(_T("Dict.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CDictApp

CDictApp theApp;


// Инициализация CDictApp
...
// Обработчики сообщений CDictApp
